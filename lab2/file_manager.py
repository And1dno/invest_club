...
working_directory = 'C:\\Users\\maxim\\PycharmProjects\\invest_club\\invest_club\\lab2' #чтобы программа работала нужно ввести в терминале pwd и полученную строку вставить в значение этой переменной
